 ...
 * Written by Sungchul Choi <scchoi@joas.co.kr>, 20. 11. 3 오후 1:17
 *
 */
 ...
 *
 * 신규프로토콜 적용 (2020-05-12)
 * Protocol_Joas_20200512_Ver_2_0.xlsx
 *
 * by Lee 20200518
 */

public class FaultManagerV2 {
    ...
    public FaultManagerV2(DSPControl2 control, Context ctx, int ch) {
        dspControl = control;
        context = ctx;
        channel = ch;
    }
            ...
            if (BitUtil.getBitBoolean(diffEvent, i) == true) {
                ...
                switch ( i ) {
                    ...
                    case 12:
                        ...
                        break;
                    case 13:
                        fInfo.errorMsg = "Reserved";        //이전 전력량계 통신 부분 FAULT
                        break;
                    case 14:
                        fInfo.errorMsg = "Reserved";        //이전 전력량계 통신 부분 FAULT
                        break;
