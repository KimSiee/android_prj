...
public class TypeDefine {
    ...
    public static final String MODEL_NAME = "JC-9BB2-14-011";
    public static final String SW_VER = "v1.0";
    public static final String SW_RELEASE_DATE = "2021-04-05";
    ...
    public static final int DEFAULT_UNIT_COST = 255; // 255원
