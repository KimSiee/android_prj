...
public class j14_touch_2ch_ChargerInfo {
...
//    public String costVersion = "";
//    public String memberCostUnitApplyDate = "";
//    public double[] memberCostUnit = new double[24];      // 단가 소수점
//    public String nonMemberCostUnitApplyDate = "";
//    public double[] nonMemberCostUnit = new double[24];   // 단가 소수점
...
//    public String reservation_costVersion = "";
//    public String reservation_memberCostUnitApplyDate = "";
//    public double[] reservation_memberCostUnit = new double[24];      // 단가 소수점
//    public String reservation_nonMemberCostUnitApplyDate = "";
//    public double[] reservation_nonMemberCostUnit = new double[24];   // 단가 소수점
    ...
    //설치정보
    public String stationId = "00000001";
    public String chargerId = "01";
    public String portNumber = "8780";
    ...
    public j14_touch_2ch_ChargerInfo() {
    ...
    public void saveCostInfo(Context context, String path, String filename, boolean isReservation) {
        ...
        try {
            ...
            LogWrapper.e("Builtin2chChargerInfo" , "Json Make Err:"+ex.toString());
        }
...
//                memberCostUnit[i] = array.getDouble(i);           // 단가 소수점
            }
...
//                nonMemberCostUnit[i] = array.getDouble(i);        // 단가 소수점
            }
        } catch (Exception ex) {
            LogWrapper.e("Builtin2chChargerInfo" , "Json Parse Err:"+ex.toString());
        }
    }
     ...
     * by Lee 20200818
     */
    public void saveDayChargingInfo(String fileDirPath, String filePath) {
        JSONObject obj = new JSONObject();
        try {
            obj.put("dayAllChargingNum", dayAllChargingNum);
            obj.put("dayAllChargingKwh", dayAllChargingKwh);
            obj.put("dayAllChargingCost", dayAllChargingCost);
        } catch (Exception ex) {
            LogWrapper.e("CertTest" , "Json Make Err:"+ex.toString());
        }

        FileUtil.stringToFile(fileDirPath, filePath, obj.toString(), false);
    }
     ...
     * @param fullPathName
     */
    public void loadDayChargingInfo(Context context, String fullPathName) {
        String loadString = null;
        try {
            loadString = FileUtil.getStringFromFile(fullPathName);
        } catch (Exception ex) {
        ...
        try {
            JSONObject obj = new JSONObject(loadString);
            dayAllChargingNum = obj.getInt("dayAllChargingNum");
            dayAllChargingKwh = obj.getInt("dayAllChargingKwh");
            dayAllChargingCost = obj.getInt("dayAllChargingCost");
