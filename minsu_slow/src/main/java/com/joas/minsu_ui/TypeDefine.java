...
public class TypeDefine {
    ...
    public static String SW_VERSION = "v0.1e";
    //public static final String SW_VERSION = "210305(CL)";
    public static String SW_RELEASE_DATE = "211027";
...
//    public static final String MODEL_NAME = "JC-92C1-7-0P";
    ...
    public static final int CP_TYPE_FAST  = 0x06;
    ...
    // 충전중 상태 정보 주기
    public static final int COMM_CHARGE_STATUS_PERIOD = 60; // 1 min
