...
public class MinsuUIActivity extends ImmersiveAppCompatActivity {
    public static final String uiVersion = "v0.1e";
    ...
    private ServiceConnection serviceConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName componentName, IBinder iBinder) {
            ...
            try {
                ...
                meterService.startAppNewPos(1, 0, 580, 1024, 25, 14.0f,0xaa000000, 0xFF00FF72);
            }catch (Exception e) {
    ...
    void initComponents() {
        TextView btHome  = (TextView) findViewById(R.id.tvContentView);
