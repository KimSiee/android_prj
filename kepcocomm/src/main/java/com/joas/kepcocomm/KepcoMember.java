...
public class KepcoMember {

    KepcoCommDbHelper dbHelper;

    public KepcoMember(KepcoCommDbHelper commDbHelper) {
    ...
    public void eraseAll()
    {
        try
        {
            String strQuery = "DELETE FROM "+KepcoCommDatabase.CardMember.TABLENAME;
    ...
    public void addMembers(String[] card_no, String[] card_pass, String[] add_cl, int cnt)
    {
        try
        {
            ...
            String strQuery  = String.format("REPLACE INTO %s(%s, %s, %s) VALUES",
                    KepcoCommDatabase.CardMember.TABLENAME,
                    KepcoCommDatabase.CardMember.CARD_NO,
                    KepcoCommDatabase.CardMember.CARD_PWD,
                    KepcoCommDatabase.CardMember.ADD_CL);
