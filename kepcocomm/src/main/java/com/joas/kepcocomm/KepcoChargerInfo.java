 ...
 */
public class KepcoChargerInfo {
    public KepcoProtocol.CPStat cp_stat = KepcoProtocol.CPStat.NONE;
    public KepcoProtocol.OutletType outlet_type = KepcoProtocol.OutletType.NONE;
    ...
    public int charge_req_cfm_mthd = KepcoProtocol.CHARGE_REQ_CFM_METHOD_FULL; // 1:full, 2:전력량, 3:금액
    ...
    //0x35
    public int charge_end_stat = KepcoProtocol.CHARGE_END_FULL; // 충전완료상태 (1:full, 2:사용자 종료, 3:고장, 오류)
    ...
    public KepcoProtocol.LocalMode localMode = KepcoProtocol.LocalMode.CARD_TAG_AUTO;
    public KepcoChargerRxInfo rxInfo = new KepcoChargerRxInfo();

    public KepcoChargeCtl chargeCtl = new KepcoChargeCtl();
    public KepcoPayRetInfo payRetInfo = new KepcoPayRetInfo();
    public KepcoPaymRxInfo payRxInfo = new KepcoPaymRxInfo();

    public class KepcoChargerRxInfo {
        public String ucost_ymd = "";
    ...
    public void initKepcoPayRet() {
        payRetInfo = new KepcoPayRetInfo();
    }
}
