...
public final class WebControllerSet_networkHandler extends MappingHandler {
  private Object mHost;

  public WebControllerSet_networkHandler(Object host, Mapping mapping, Addition addition,
      boolean isRest) {
  ...
  public View handle(HttpRequest request, HttpResponse response) throws IOException {
    ...
    Object o = null;
    try {
      o = ((WebController)mHost).set_network(request, response);
    }
    catch (Throwable e) {
      throw e;
    }
