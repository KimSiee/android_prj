  ...
  public WebControllerAdapter() {
    ...
    this.mMappingMap = new LinkedHashMap<>();
...

     {
      ...
      Path path = new Path();
      path.addRule("/api/getocppsetting/{token}");
      mapping.setPath(path);
      ...
      Addition addition = new Addition();
      WebControllerGet_ocppsettingHandler handler = new WebControllerGet_ocppsettingHandler(mHost, mapping, addition, true);
      mMappingMap.put(mapping, handler);
    }
...

     {
      ...
      Path path = new Path();
      path.addRule("/api/getrecentocppcommlog/{token}");
      mapping.setPath(path);
      ...
      Addition addition = new Addition();
      WebControllerGet_recentocppcommlogHandler handler = new WebControllerGet_recentocppcommlogHandler(mHost, mapping, addition, true);
      mMappingMap.put(mapping, handler);
    }
...

     {
      ...
      Path path = new Path();
      path.addRule("/api/setocppsetting");
      mapping.setPath(path);
      ...
      Addition addition = new Addition();
      WebControllerSet_ocppsettingHandler handler = new WebControllerSet_ocppsettingHandler(mHost, mapping, addition, true);
      mMappingMap.put(mapping, handler);
    }
