...
public final class WebControllerSet_ocppsettingHandler extends MappingHandler {
  private Object mHost;

  public WebControllerSet_ocppsettingHandler(Object host, Mapping mapping, Addition addition,
      boolean isRest) {
  ...
  public View handle(HttpRequest request, HttpResponse response) throws IOException {
    ...
    Object o = null;
    try {
      o = ((WebController)mHost).set_ocppsetting(request, response);
    }
    catch (Throwable e) {
      throw e;
    }
