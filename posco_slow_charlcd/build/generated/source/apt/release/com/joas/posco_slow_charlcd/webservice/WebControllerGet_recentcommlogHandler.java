...
public final class WebControllerGet_recentcommlogHandler extends MappingHandler {
  private Object mHost;

  public WebControllerGet_recentcommlogHandler(Object host, Mapping mapping, Addition addition,
      boolean isRest) {
  ...
  public View handle(HttpRequest request, HttpResponse response) throws IOException {
    ...
    Object o = null;
    try {
      o = ((WebController)mHost).get_recentcommlog(path0);
    }
    catch (Throwable e) {
      throw e;
    }
