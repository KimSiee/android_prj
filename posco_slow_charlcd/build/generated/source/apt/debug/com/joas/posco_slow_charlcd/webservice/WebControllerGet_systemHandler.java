...
public final class WebControllerGet_systemHandler extends MappingHandler {
  private Object mHost;

  public WebControllerGet_systemHandler(Object host, Mapping mapping, Addition addition,
      boolean isRest) {
  ...
  public View handle(HttpRequest request, HttpResponse response) throws IOException {
    ...
    Object o = null;
    try {
      o = ((WebController)mHost).get_system(path0);
    }
    catch (Throwable e) {
      throw e;
    }
