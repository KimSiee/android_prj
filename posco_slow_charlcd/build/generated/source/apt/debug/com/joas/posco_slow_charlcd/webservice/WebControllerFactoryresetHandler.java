...
public final class WebControllerFactoryresetHandler extends MappingHandler {
  private Object mHost;

  public WebControllerFactoryresetHandler(Object host, Mapping mapping, Addition addition,
      boolean isRest) {
  ...
  public View handle(HttpRequest request, HttpResponse response) throws IOException {
    ...
    Object o = null;
    try {
      o = ((WebController)mHost).factoryreset(path0);
    }
    catch (Throwable e) {
      throw e;
    }
