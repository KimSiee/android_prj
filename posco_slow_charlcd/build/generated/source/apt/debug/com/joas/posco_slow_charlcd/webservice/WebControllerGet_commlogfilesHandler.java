...
public final class WebControllerGet_commlogfilesHandler extends MappingHandler {
  private Object mHost;

  public WebControllerGet_commlogfilesHandler(Object host, Mapping mapping, Addition addition,
      boolean isRest) {
  ...
  public View handle(HttpRequest request, HttpResponse response) throws IOException {
    ...
    Object o = null;
    try {
      o = ((WebController)mHost).get_commlogfiles(path0);
    }
    catch (Throwable e) {
      throw e;
    }
