...
public final class WebControllerGetHandler extends MappingHandler {
  private Object mHost;

  public WebControllerGetHandler(Object host, Mapping mapping, Addition addition, boolean isRest) {
  ...
  public View handle(HttpRequest request, HttpResponse response) throws IOException {
    ...
    Object o = null;
    try {
      o = ((WebController)mHost).get(request, response);
    }
    catch (Throwable e) {
      throw e;
    }
