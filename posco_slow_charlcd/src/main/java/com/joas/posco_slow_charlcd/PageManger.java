...
import com.joas.posco_slow_charlcd.page.AdminPasswordInputView;
import com.joas.posco_slow_charlcd.page.AuthWaitView;
import com.joas.posco_slow_charlcd.page.CardTagView;
import com.joas.posco_slow_charlcd.page.ChargingView;
import com.joas.posco_slow_charlcd.page.ConnectCarWaitView;
import com.joas.posco_slow_charlcd.page.ConnectorWaitView;
import com.joas.posco_slow_charlcd.page.DSPCommErrView;
import com.joas.posco_slow_charlcd.page.EmergencyBoxView;
import com.joas.posco_slow_charlcd.page.FaultBoxView;
import com.joas.posco_slow_charlcd.page.FinishChargingView;
import com.joas.posco_slow_charlcd.page.InputAuthNumView;
import com.joas.posco_slow_charlcd.page.InputCellPhonNumView;
import com.joas.posco_slow_charlcd.page.JoasCommMonitorView;
import com.joas.posco_slow_charlcd.page.JoasDSPMonitorView;
import com.joas.posco_slow_charlcd.page.JoasDebugMsgView;
import com.joas.posco_slow_charlcd.page.MessageBoxView;
import com.joas.posco_slow_charlcd.page.OcppCommMonitorView;
import com.joas.posco_slow_charlcd.page.PageActivateListener;
import com.joas.posco_slow_charlcd.page.PageAuthSelectView;
import com.joas.posco_slow_charlcd.page.PageID;
import com.joas.posco_slow_charlcd.page.PagePartialCancePayment;
import com.joas.posco_slow_charlcd.page.PageQRCertWait;
import com.joas.posco_slow_charlcd.page.PageReadyView;
import com.joas.posco_slow_charlcd.page.PageUnplugView;
import com.joas.posco_slow_charlcd.page.PaymentCancelpayView;
import com.joas.posco_slow_charlcd.page.PaymentPrepayView;
import com.joas.posco_slow_charlcd.page.PaymentRealPayView;
import com.joas.posco_slow_charlcd.page.SelectFastView;
import com.joas.posco_slow_charlcd.page.SelectSlowView;
import com.joas.posco_slow_charlcd.page.SettingView;
import com.joas.posco_slow_charlcd.page.UnavailableConView;
...
public class PageManger {
    ...
    PageAuthSelectView pageSelectAuthView;
    ...
    PageQRCertWait pageQRCertWait;
    PagePartialCancePayment pagePartialCancePayment;
    FinishChargingView finishChargingView;
    SettingView settingView;
    InputCellPhonNumView inputCellPhonNumView;
    InputAuthNumView inputAuthNumView;
    PaymentPrepayView paymentPrepayView;
    PaymentCancelpayView paymentCancelpayView;
    PaymentRealPayView paymentRealPayView;
    ...
    OcppCommMonitorView ocppCommMonitorView;
    ...
    public void init(UIFlowManager uiManager, MeterConfig mconfig, CPConfig config, Activity activity) {
        flowManager = uiManager;
        mainActivity = activity;
        this.cpconfig = config;
        this.meterConfig = mconfig;
        initPages();
    }

    void initPages() {
        pageReadyView = new PageReadyView(baseContext,flowManager,mainActivity);
        pageSelectAuthView = new PageAuthSelectView(baseContext,flowManager,mainActivity);
        ...
        pageQRCertWait = new PageQRCertWait(baseContext,flowManager,mainActivity);
        pagePartialCancePayment = new PagePartialCancePayment(baseContext,flowManager,mainActivity);
        finishChargingView = new FinishChargingView(baseContext, flowManager, mainActivity);
        inputCellPhonNumView = new InputCellPhonNumView(baseContext,flowManager,mainActivity);
        inputAuthNumView = new InputAuthNumView(baseContext,flowManager,mainActivity);
        paymentPrepayView = new PaymentPrepayView(baseContext,flowManager,mainActivity);
        paymentCancelpayView = new PaymentCancelpayView(baseContext,flowManager,mainActivity);
        paymentRealPayView = new PaymentRealPayView(baseContext,flowManager,mainActivity);
        ...
        ocppCommMonitorView = new OcppCommMonitorView(baseContext,flowManager,mainActivity);
        ...
        flowManager.getCommManager().setMonitorListener(commMonitorView); // 모니터링 리스너 등록
        ...
        {
            if(cpconfig.useKakaoNavi) changePage(PageID.SELECT_AUTH);
            else changePage(PageID.PAGE_READY);
        }
        else changePage(PageID.CARD_TAG);
    }

    public PageReadyView getPageReadyView(){return pageReadyView;}
    public PageAuthSelectView getPageSelectAuthView(){return pageSelectAuthView;}
    ...
    public PageQRCertWait getPageQRCertWait(){return pageQRCertWait;}
    public PagePartialCancePayment getPagePartialCancePayment(){return pagePartialCancePayment;}
    ...
    public OcppCommMonitorView getOcppCommMonitorView(){return ocppCommMonitorView;}
    public InputCellPhonNumView getInputCellPhonNumView(){return inputCellPhonNumView;}
    public InputAuthNumView getInputAuthNumView(){return inputAuthNumView;}
    public PaymentPrepayView getPaymentPrepayView(){return paymentPrepayView;}
    public PaymentCancelpayView getPaymentCancelpayView(){return paymentCancelpayView;}
    public PaymentRealPayView getPaymentRealPayView(){return paymentRealPayView;}
    ...
    Object getPageViewByID(PageID id) {
        ...
        switch ( id ) {
            ...
            case SELECT_FAST:
                ...
                break;
            case INPUT_CELL_NUM:
                v = getInputCellPhonNumView();
                break;
            case INPUT_AUTH_NUM:
                v = getInputAuthNumView();
                break;
            case PAYMENT_PREPAY:
                v = getPaymentPrepayView();
                break;
            case PAYMENT_CANCEL_PAY:
                v = getPaymentCancelpayView();
                break;
            case PAYMENT_REAL_PAY:
                v = getPaymentRealPayView();
                break;
            case CARD_TAG:
                v = getCardTagView();
                break;
            ...
            case UNPLUG:
                v = getPageUnplugView();
                break;
            case KAKAO_QRCERT_WAIT:
                v = getPageQRCertWait();
                break;
            case PAYMENT_PARTIAL_CANCEL_PAY:
                v = getPagePartialCancePayment();
                break;
