...
public class KevcsUIActivity extends ImmersiveAppCompatActivity {
    public static final String uiVersion = "v0.1";
    static KevcsUIActivity mainActivity = null;
    ...
    static public KevcsUIActivity getMainActivity() { return mainActivity; }
