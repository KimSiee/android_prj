 ...
 * Written by Sungchul Choi <scchoi@joas.co.kr>, 18. 7. 16 오전 11:26
 *
 */
...
public class SelectAmountTypeView extends LinearLayout implements PageActivateListener {
    ...
    void initComponents() {
        ...
        ImageButton btFull  = (ImageButton) findViewById(R.id.btSelAmountFull);
    ...
    public void onFullClick() {
        flowManager.onPageSelectAmountType(PageEvent.SELECT_AMOUNT_FULL_CLICK);
    }
