...
public class CreditRealPayView extends LinearLayout implements PageActivateListener {
    UIFlowManager flowManager;
    TextView tvPrePayValue;

    public CreditRealPayView(Context context, UIFlowManager manager, Activity activity) {
        super(context);
        flowManager = manager;

        LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        inflater.inflate(R.layout.page_credit_realpay, this, true);
    ...
    public void onPageActivate() {
        ...
        tvPrePayValue.setText((int)cData.chargingCost+"원");
    }
