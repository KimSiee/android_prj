 ...
 * Written by Sungchul Choi <scchoi@joas.co.kr>, 18. 7. 13 오후 3:59
 *
 */
...
import com.joas.kevcs.ui.page.AdminPasswordInputView;
import com.joas.kevcs.ui.page.AuthMemberCardView;
import com.joas.kevcs.ui.page.AuthPayWaitView;
import com.joas.kevcs.ui.page.ChargingStopAskView;
import com.joas.kevcs.ui.page.ChargingView;
import com.joas.kevcs.ui.page.ConnectCarWaitView;
import com.joas.kevcs.ui.page.ConnectorWaitView;
import com.joas.kevcs.ui.page.CreditCardPayView;
import com.joas.kevcs.ui.page.EmergencyBoxView;
import com.joas.kevcs.ui.page.FaultBoxView;
import com.joas.kevcs.ui.page.FinishChargingErrorView;
import com.joas.kevcs.ui.page.FinishChargingView;
import com.joas.kevcs.ui.page.InputCostView;
import com.joas.kevcs.ui.page.InputKwhView;
import com.joas.kevcs.ui.page.InputNumberView;
import com.joas.kevcs.ui.page.InputPasswordView;
import com.joas.kevcs.ui.page.JoasDSPMonitorView;
import com.joas.kevcs.ui.page.JoasDebugMsgView;
import com.joas.kevcs.ui.page.MessageBoxView;
import com.joas.kevcs.ui.page.PageActivateListener;
import com.joas.kevcs.ui.page.PageID;
import com.joas.kevcs.ui.page.SelectAmountTypeView;
import com.joas.kevcs.ui.page.SelectAuthView;
import com.joas.kevcs.ui.page.SelectFastView;
import com.joas.kevcs.ui.page.SelectSlowView;
import com.joas.kevcs.ui.page.SettingView;
import com.joas.kevcs.ui.page.StartView;
import com.joas.kevcs.ui.page.UnPlugView;
import com.joas.kevcs.ui.page.CreditRealPayView;
import com.joas.kevcs.ui.page.CreditCancelPrePayView;
...
public class PageManger {
    ...
    CreditRealPayView creditRealPayView;
    CreditCancelPrePayView creditCancelPrePayView;
    ...
    void initPages() {
        ...
        creditRealPayView = new CreditRealPayView(baseContext, flowManager, mainActivity);
        creditCancelPrePayView = new CreditCancelPrePayView(baseContext, flowManager, mainActivity);
    ...
    public CreditRealPayView getCreditRealPayView() { return creditRealPayView; }
    public CreditCancelPrePayView getCreditCancelPrePayView() { return creditCancelPrePayView;}
    ...
    Object getPageViewByID(PageID id) {
        ...
        switch ( id ) {
            ...
            case UNPLUG: v = getUnPlugView();
                break;
            case CREDIT_REAL_PAY: v = getCreditRealPayView();
                break;
            case CREDIT_CANCEL_PREPAY: v = getCreditCancelPrePayView();
                break;
        }
        return v;
    }
