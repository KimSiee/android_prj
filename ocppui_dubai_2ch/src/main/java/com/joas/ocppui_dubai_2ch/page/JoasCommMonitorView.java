...
public class JoasCommMonitorView extends FrameLayout implements OCPPTransportMonitorListener {
    ...
    void addOCPPRawMsg(String trx, String data) {
    ...
    public void onOCPPTransportRecvRaw(String data) {
        addOCPPRawMsg("RX", data);
        uiManager.onOcppMessageTransportEvent();
    }

    @Override
    public void onOCPPTransportSendRaw(String data) {
        addOCPPRawMsg("TX", data);
        uiManager.onOcppMessageTransportEvent();
    }

    @Override
    public void onOCPPTransportConnected() {
        uiManager.onChangeOcppServerConnectStatus(true);
    }

    @Override
    public void onOCPPTransportDisconnected() {
        uiManager.onChangeOcppServerConnectStatus(false);
    }
}
