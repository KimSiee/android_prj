...
public class JoasDebugMsgView extends FrameLayout {
    ...
    com.joas.minsu_ui_charlcd.page.JoasDbgMsgListAdapter packetListAdapter;
    ...
    void initComponents() {
        ...
        packetListAdapter = new com.joas.minsu_ui_charlcd.page.JoasDbgMsgListAdapter(mainActivity, packetQueue);
