...
public class SettingView extends LinearLayout implements PageActivateListener {
    ...
    Switch switchSettingUseTestMode;
    ...
    void initComponents() {
        ...
        switchSettingUseTestMode = (Switch)findViewById(R.id.switchSettingTestFlag);
...
//        tl3500S.cancelPrePay(0);
    ...
    void saveCPConfig() {
        ...
        flowManager.getCpConfig().useTestMode = switchSettingUseTestMode.isChecked();
    ...
    void loadCPConfig() {
        ...
        switchSettingUseTestMode.setChecked(flowManager.getCpConfig().useTestMode);
        ...
        else if(flowManager.getCpConfig().chargerKind.equals("2H"))
            chargerkindSpinner.setSelection(3);
    }
    ...
    public void onPageActivate() {
        ...
        //UI SW version
        Volvo2chChargerInfo vinfo = flowManager.getUIFlowManager(0).getVolvoChargerInfo();
        String version = vinfo.chg_sw_version;
        tvVersion.setText(version);

        //FW version
        int dspversion = flowManager.getUIFlowManager(0).getDspVersion();
