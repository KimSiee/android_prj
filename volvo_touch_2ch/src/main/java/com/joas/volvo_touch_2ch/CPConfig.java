...
public class CPConfig {
    ...
    public static final String CP_CONFIG_TESTMODE_USE = "TestMode";
    ...
    public boolean useTestMode = false;
    public String chargerKind = "2H";
    ...
    public void loadConfig(Context context) {
        ...
        if (loadString == null ) {
            ...
            try {
                ...
                chargerID2 = obj.getString(CP_CONFIG_CP_ID2);
                ...
                useTestMode = obj.getBoolean(CP_CONFIG_TESTMODE_USE);
    ...
    public void saveConfig(Context context) {
        ...
        try {
            ...
            obj.put(CP_CONFIG_TESTMODE_USE,useTestMode);
