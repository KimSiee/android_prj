...
public class TypeDefine {
    public static final String SW_VERSION = "V1.1";
    public static final String SW_RELEASE_DATE = "2022.03.23";
    ...
    public static final String KEPCO_COMM_PATH = REPOSITORY_BASE_PATH + "/Comm";
    ...
    public static final String FAST_MODEL_NAME = "JC-9931KE";
    public static final String SLOW_MODEL_NAME = "JC-9111KE";
