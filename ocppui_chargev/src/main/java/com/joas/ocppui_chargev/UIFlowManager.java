...
import com.joas.ocppui_chargev.page.PageEvent;
...
public class UIFlowManager implements RfidReaderListener, DSPControl2Listener, OCPPSessionManagerListener,
    ...
    OCPPUIChargevActivity mainActivity;
    ...
    public UIFlowManager(OCPPUIChargevActivity activity, ChargeData data, CPConfig config, MeterConfig mconfig, String restartReason) {
...
//        rfidReader = new RfidReaderSehan("/dev/ttyS3", RfidReaderSehan.RFID_CMD.RFID_AUTO_MYFARE);
        ...
        // UpdateManager를 생성한다.
        updateManager = new UpdateManager(mainActivity, this, OCPPUIChargevActivity.uiVersion);
...
//                    ocppSessionManager.sendFirmwareStatusNotification(FirmwareStatusNotification.Status.INSTALLING);
                    updateManager.doInstallFirmware(OCPPUIChargevActivity.uiVersion);
                }
            }
        }
    }
