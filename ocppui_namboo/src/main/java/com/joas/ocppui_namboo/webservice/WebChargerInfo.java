...
package com.joas.ocppui_namboo.webservice;
...
import com.joas.ocppui_namboo.CPConfig;
import com.joas.ocppui_namboo.OCPPUINambooActivity;
import com.joas.ocppui_namboo.TypeDefine;
...
public class WebChargerInfo {
    ...
    public static JSONObject getVersions() {
        UIFlowManager flowManager = OCPPUINambooActivity.getMainActivity().getFlowManager();
    ...
    public static JSONObject getChargerStat() {
        ...
        try {
            ...
            json.put("comm", OCPPUINambooActivity.getMainActivity().getIsCommConnected() ? "Connected" : "Disconnected");
    ...
    public static void setChargerSetting(JSONObject json) {
        ...
        try {
            ...
            cpConfig.saveConfig(OCPPUINambooActivity.getMainActivity().getApplicationContext());
    ...
    public static JSONArray getRecentSysLog() {
        CircularArray<LogWrapperMsg> queue = OCPPUINambooActivity.getMainActivity().getPageManger().getJoasDebugMsgView().getPacketQueue();
        int cnt = queue.size();
        JSONArray array = new JSONArray();
        try {
            synchronized (queue) {
    ...
    public static JSONArray getRecentCommLog() {
        CircularArray<JoasCommMonitorView.OCPPMonitorMsg> queue = OCPPUINambooActivity.getMainActivity().getPageManger().getCommMonitorView().getPacketQueue();
    ...
    public static JSONArray getAuthCacheList() {
        Map<String, IdTagInfo> list = OCPPUINambooActivity.getMainActivity().getFlowManager().getOcppSessionManager().getOcppStack().getAuthorizeCache().getAllCacheIdTag();
        JSONArray array = new JSONArray();
        try {
            String k;
            IdTagInfo v;
    ...
    public static JSONArray getLocalAuthList() {
        Map<String, IdTagInfo> list = OCPPUINambooActivity.getMainActivity().getFlowManager().getOcppSessionManager().getOcppStack().getLocalAuthList().getAllLocalAuthList();
        JSONArray array = new JSONArray();
        try {
            String k;
            IdTagInfo v;
