...
public class JoasDebugMsgView extends FrameLayout {
    ...
    com.joas.gridwiz_slow_charlcd.page.JoasDbgMsgListAdapter packetListAdapter;
    ...
    public JoasDebugMsgView(Context context, UIFlowManager manager, Activity activity) {
        super(context);
    ...
    void initComponents() {
        ...
        packetListAdapter = new com.joas.gridwiz_slow_charlcd.page.JoasDbgMsgListAdapter(mainActivity, packetQueue);
    ...
    public CircularArray<LogWrapperMsg> getPacketQueue() {
        return packetQueue;
    }
