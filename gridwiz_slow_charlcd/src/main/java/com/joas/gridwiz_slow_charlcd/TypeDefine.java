...
public class TypeDefine {
    public static final String SW_VERSION = "J201223A";
    public static final String SW_RELEASE_DATE = "2020-12-23";
    ...
    public static final int DEFAULT_UNIT_COST = 173; // 100원      //단가 타입 변환
//    public static final double DEFAULT_UNIT_COST = 173.80; // 100원
    ...
    public static final int METER_COMM_ERR_TIMEOUT = 60;      //1min
    ...
    public static final int DISP_CHARGING_CHARLCD_PERIOD = 8; // 8초
    ...
    public static final String COST_INFO_FILENAME = "costInfo.json";
    public static final String COST_RESERVATION_INFO_FILENAME = "costInfo_reservation.json";
}
