...
public class AlarmCode {
    ...
    public static final int ERR_CODE_3 = 0x03; //errcode 3 : 완속 충전기 접지 이상
    ...
    public static final int ERR_CODE_7 = 0x07; //errcode 7 : 완속 입력/휴즈 이상
    ...
    public static final int ERR_CODE_10 = 0x10; //errcode 10 : 완속 차량통신이상
    public static final int ERR_CODE_11 = 0x11; //errcode 11 : 내부통신 이상
    public static final int ERR_CODE_12 = 0x12; //errcode 12 : 전력량계 통신이상
