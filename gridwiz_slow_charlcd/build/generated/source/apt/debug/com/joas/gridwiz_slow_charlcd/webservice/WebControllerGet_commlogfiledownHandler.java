...
public final class WebControllerGet_commlogfiledownHandler extends MappingHandler {
  private Object mHost;

  public WebControllerGet_commlogfiledownHandler(Object host, Mapping mapping, Addition addition,
      boolean isRest) {
  ...
  public View handle(HttpRequest request, HttpResponse response) throws IOException {
    ...
    String path1Str = pathMap.get("filename");
    if (StringUtils.isEmpty(path1Str)) {
      throw new PathMissingException("filename");
    }
    String path1 = null;
    try {
    ...
    Object o = null;
    try {
      o = ((WebController)mHost).get_commlogfiledown(path0, path1);
    }
    catch (Throwable e) {
      throw e;
    }
