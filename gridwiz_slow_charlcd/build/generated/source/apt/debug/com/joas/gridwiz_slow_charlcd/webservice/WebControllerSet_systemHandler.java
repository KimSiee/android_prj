...
public final class WebControllerSet_systemHandler extends MappingHandler {
  private Object mHost;

  public WebControllerSet_systemHandler(Object host, Mapping mapping, Addition addition,
      boolean isRest) {
  ...
  public View handle(HttpRequest request, HttpResponse response) throws IOException {
    ...
    Object o = null;
    try {
      o = ((WebController)mHost).set_system(request, response);
    }
    catch (Throwable e) {
      throw e;
    }
