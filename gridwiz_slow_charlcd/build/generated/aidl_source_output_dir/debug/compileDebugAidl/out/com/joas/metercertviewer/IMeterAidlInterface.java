 ...
 * Original file: C:\\project\\SmartCharger\\android\\SmartCharger\\gridwiz_slow_charlcd\\src\\main\\aidl\\com\\joas\\metercertviewer\\IMeterAidlInterface.aidl
 */
...
int _arg7;
_arg7 = data.readInt();
this.startAppNewPos(_arg0, _arg1, _arg2, _arg3, _arg4, _arg5, _arg6, _arg7);
reply.writeNoException();
return true;
}
...
@Override public void startApp(int uiVer) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
@Override public void startAppNewPos(int uiVer, int x, int y, int w, int h, float fontSize, int backColor, int foreColor) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
android.os.Parcel _reply = android.os.Parcel.obtain();
try {
...
static final int TRANSACTION_startApp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 3);
static final int TRANSACTION_startAppNewPos = (android.os.IBinder.FIRST_CALL_TRANSACTION + 4);
static final int TRANSACTION_stopApp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 5);
static final int TRANSACTION_setCharLCDRotatePeriod = (android.os.IBinder.FIRST_CALL_TRANSACTION + 6);
static final int TRANSACTION_setCharLCDBacklight = (android.os.IBinder.FIRST_CALL_TRANSACTION + 7);
static final int TRANSACTION_setCharLCDDisp = (android.os.IBinder.FIRST_CALL_TRANSACTION + 8);
}
...
public void startApp(int uiVer) throws android.os.RemoteException;
public void startAppNewPos(int uiVer, int x, int y, int w, int h, float fontSize, int backColor, int foreColor) throws android.os.RemoteException;
