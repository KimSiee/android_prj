 ...
 * Written by Sungchul Choi <scchoi@joas.co.kr>, 18. 7. 2 오전 11:15
 *
 */
...
public class ChargeData {
     ...
     */
    public TypeDefine.ConnectorType connectorType = TypeDefine.ConnectorType.NONE;
    ...
    public long lastMeterValue = 0;
    public float chargingVoltage = 0.0f;
    public float chargingAmpare = 0.0f;

    //전력제한값
    public int powerLimitValue  = TypeDefine.POWER_DOUBLE_MODE;
    /**
     * 메시지 박스 타이틀
     */
    ...
    public boolean messageBoxInfiniteMode = false;
