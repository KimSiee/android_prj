...
public class JoasDSPMonitorView extends FrameLayout implements DSPMonitorListener {
    ...
    void initCommMonitor() {
        ...
        Button btDSPMNTHide = (Button) findViewById(R.id.btDSPMNTHide);
        btDSPMNTHide.setOnClickListener(new OnClickListener() {
            @Override
        ...
        Button btDSPViewClear = (Button) findViewById(R.id.btDSPViewClear);
        btDSPViewClear.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                onClear();
            }
    ...
    public void onDspTxDataEvent(int channel, DSPTxData txData) {
        if ( channel == 0 ) packetListAdapter.updateTxData(txData.rawData);
    }
