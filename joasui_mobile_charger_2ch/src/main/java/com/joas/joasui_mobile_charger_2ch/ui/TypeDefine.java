...
public class TypeDefine {
    ...
    public static final int CHANNEL_MAX_CNT = 2;
    ...
    public static final int MESSAGEBOX_TIMEOUT_SHORT = 2; //sec
    ...
    public static final int POWER_SINGLE_MODE = 26;
    public static final int POWER_DOUBLE_MODE = 13;
    ...
    public static final String CP_LOG_PATH = REPOSITORY_BASE_PATH + "/CPLog";
}
