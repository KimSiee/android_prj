...
public class UIFlowManager implements RfidReaderListener, DSPControl2Listener, OCPPSessionManagerListener,
    ...
    OCPPUITardisActivity mainActivity;
    ...
    public UIFlowManager(OCPPUITardisActivity activity, ChargeData data, CPConfig config, MeterConfig mconfig, String restartReason) {
...
//        rfidReader = new RfidReaderSehan("/dev/ttyS3", RfidReaderSehan.RFID_CMD.RFID_AUTO_MYFARE);
        ...
        // UpdateManager를 생성한다.
        updateManager = new UpdateManager(mainActivity, this, OCPPUITardisActivity.uiVersion);
...
//                    ocppSessionManager.sendFirmwareStatusNotification(FirmwareStatusNotification.Status.INSTALLING);
                    updateManager.doInstallFirmware(OCPPUITardisActivity.uiVersion);
                }
            }
        }
    }
