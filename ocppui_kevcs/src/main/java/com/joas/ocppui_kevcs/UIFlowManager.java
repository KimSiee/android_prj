...
import com.joas.ocppui_kevcs.page.PageEvent;
...
public class UIFlowManager implements RfidReaderListener, DSPControl2Listener, OCPPSessionManagerListener,
    ...
    OCPPUIKevcsActivity mainActivity;
    ...
    public UIFlowManager(OCPPUIKevcsActivity activity, ChargeData data, CPConfig config, MeterConfig mconfig, String restartReason) {
...
//        rfidReader = new RfidReaderSehan("/dev/ttyS3", RfidReaderSehan.RFID_CMD.RFID_AUTO_MYFARE);
        ...
        // UpdateManager를 생성한다.
        updateManager = new UpdateManager(mainActivity, this, OCPPUIKevcsActivity.uiVersion);
...
//                    ocppSessionManager.sendFirmwareStatusNotification(FirmwareStatusNotification.Status.INSTALLING);
                    updateManager.doInstallFirmware(OCPPUIKevcsActivity.uiVersion);
                }
            }
        }
    }
