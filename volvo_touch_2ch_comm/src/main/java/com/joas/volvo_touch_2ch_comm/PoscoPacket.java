...
public class PoscoPacket {
     ...
     */
    public static int fillBasicField(byte[] vdData, Volvo2chChargerInfo info) {
        int idx = 0;

        ByteUtil.wordToByteArray(info.cpMode[info.infoch], vdData, idx);
        idx += 2;

        ByteUtil.longToByteArray(info.cpStatus[info.infoch], vdData, 8, idx);
        idx += 8;

        ByteUtil.intToByteArray(info.meterVal[info.infoch], vdData, idx);
        idx += 4;
        return idx;
    }

    public static int fillChargingStatus(byte[] vdData, int idx, Volvo2chChargerInfo info) {
...
//        vdData[idx++] = hexRemainTime[1];
    ...
    public static int fillInstallationInfo(byte[] vdData, int idx, Volvo2chChargerInfo info) {
    ...
    public static class BasicResponse {
        ...
        public byte[] encode(Volvo2chChargerInfo info) {
    ...
    public static class BasicResponseCode {
        ...
        public byte[] encode(Volvo2chChargerInfo info, int ackCode, int reasonCode) {
            byte[] vdData = new byte[VD_DATA_SIZE];
...
//        }
    ...
    public static class AlarmInfo_c1 {
        ...
        public byte[] encode(Volvo2chChargerInfo info, int alarmCode, byte alarmStatus) {
            byte[] vdData = new byte[VD_DATA_SIZE];
...
//            idx += 3;
    ...
    public static class NonTransPacket_i1  {
        public byte[] encode(Volvo2chChargerInfo info, int dataIndex, byte[] rawData) {
    ...
    public static class ChargerFirmwareReq_m1 {
        ...
        public byte[] encode(Volvo2chChargerInfo info, byte dest1, byte dest2) {
            byte[] vdData = new byte[VD_DATA_SIZE];
            int idx = fillBasicField(vdData, info);
