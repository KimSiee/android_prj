...
package com.joas.ocppui.webservice;
...
import com.joas.ocppui.CPConfig;
import com.joas.ocppui.OCPPUIActivity;
import com.joas.ocppui.TypeDefine;
...
public class WebChargerInfo {
    ...
    public static JSONObject getVersions() {
        UIFlowManager flowManager = OCPPUIActivity.getMainActivity().getFlowManager();
    ...
    public static JSONArray getRecentSysLog() {
        CircularArray<LogWrapperMsg> queue = OCPPUIActivity.getMainActivity().getPageManger().getJoasDebugMsgView().getPacketQueue();
        int cnt = queue.size();
        JSONArray array = new JSONArray();
        try {
            synchronized (queue) {
    ...
    public static JSONArray getRecentCommLog() {
        CircularArray<JoasCommMonitorView.OCPPMonitorMsg> queue = OCPPUIActivity.getMainActivity().getPageManger().getCommMonitorView().getPacketQueue();
    ...
    public static JSONArray getAuthCacheList() {
        Map<String, IdTagInfo> list = OCPPUIActivity.getMainActivity().getFlowManager().getOcppSessionManager().getOcppStack().getAuthorizeCache().getAllCacheIdTag();
        JSONArray array = new JSONArray();
        try {
            String k;
            IdTagInfo v;
    ...
    public static JSONArray getLocalAuthList() {
        Map<String, IdTagInfo> list = OCPPUIActivity.getMainActivity().getFlowManager().getOcppSessionManager().getOcppStack().getLocalAuthList().getAllLocalAuthList();
        JSONArray array = new JSONArray();
        try {
            String k;
            IdTagInfo v;
